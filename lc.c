...
typedef struct lambda *pcc_value_t;

typedef struct ctx *pcc_auxil_t;
...
static bool pcc_apply_rule(lc_context_t *ctx, pcc_rule_t rule, pcc_thunk_array_t *thunks, pcc_value_t *value) {
...
static void pcc_action_abstraction_0(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define ID (*__pcc_in->data.leaf.values.buf[0])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const)__pcc_in->data.leaf.capt0.range.start)
#define _0e ((const)__pcc_in->data.leaf.capt0.range.end)
    if (indexof(auxil,ID->atom.s)) PCC_ERROR(auxil); ctx_push(auxil,ID->atom.s);
#undef _0e
#undef _0s
#undef _0
#undef ID
...
static void pcc_action_abstraction_1(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define ID (*__pcc_in->data.leaf.values.buf[0])
...
#define _0e ((const)__pcc_in->data.leaf.capt0.range.end)
    ctx_pop(auxil);
    __=(struct lambda *)malloc(sizeof(struct lambda));
    if (!__) PCC_ERROR(auxil);
    __->t=LAMBDA_ABSTR;
    __->abstr.v=ID->atom.s; free(ID);
    __->abstr.expr=T;
#undef _0e
#undef _0s
#undef _0
...
static void pcc_action_application_0(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
...
static void pcc_action_application_1(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define T (*__pcc_in->data.leaf.values.buf[1])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
...
static void pcc_action_atom_0(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define ID (*__pcc_in->data.leaf.values.buf[0])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
...
static void pcc_action_atom_1(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define T (*__pcc_in->data.leaf.values.buf[1])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
...
static void pcc_action_ID_0(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const)__pcc_in->data.leaf.capt0.range.start)
...
#define _1e __pcc_in->data.leaf.capts.buf[0]->range.end
    ...
    __->t=LAMBDA_ATOM;
    __->atom.s=strdup(_1);
    if (!__->atom.s) PCC_ERROR(auxil);
    __->atom.index=indexof(auxil,_1);
#undef _1e
#undef _1s
#undef _1
#undef _0e
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_abstraction(lc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_application(lc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_atom(lc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_ID(lc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_LAMBDA(lc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_DOT(lc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_LP(lc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_RP(lc_context_t *ctx);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_term(lc_context_t *ctx) {
    ...
    pcc_value_table__resize(ctx->auxil, &chunk->values, 1);
    {
        ...
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_application, &chunk->thunks, &(chunk->values.buf[0]))) goto L0002;
        goto L0001;
    L0002:;
        ctx->pos = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_abstraction, &chunk->thunks, &(chunk->values.buf[0]))) goto L0003;
        goto L0001;
    L0003:;
        ctx->pos = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
    ...
    {
        pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_term_0, 1, 0);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_abstraction(lc_context_t *ctx) {
    ...
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_LAMBDA, &chunk->thunks, NULL)) goto L0000;
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_ID, &chunk->thunks, &(chunk->values.buf[0]))) goto L0000;
    {
        pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_abstraction_0, 2, 0);
        thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
        thunk->data.leaf.capt0.range.start = chunk->pos;
        thunk->data.leaf.capt0.range.end = ctx->pos;
        pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
    ...
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_term, &chunk->thunks, &(chunk->values.buf[1]))) goto L0000;
    {
        pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_abstraction_1, 2, 0);
        thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_application(lc_context_t *ctx) {
    ...
    pcc_value_table__resize(ctx->auxil, &chunk->values, 2);
    {
        ...
        int n = chunk->thunks.len;
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_application, &chunk->thunks, &(chunk->values.buf[0]))) goto L0002;
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_atom, &chunk->thunks, &(chunk->values.buf[1]))) goto L0002;
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_application_0, 2, 0);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.values.buf[1] = &(chunk->values.buf[1]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
    ...
    L0002:;
        ctx->pos = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_atom, &chunk->thunks, &(chunk->values.buf[1]))) goto L0003;
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_application_1, 2, 0);
            thunk->data.leaf.values.buf[1] = &(chunk->values.buf[1]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_atom(lc_context_t *ctx) {
    ...
    pcc_value_table__resize(ctx->auxil, &chunk->values, 2);
    {
        ...
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_atom_0, 2, 0);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
    ...
    L0002:;
        ctx->pos = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_LP, &chunk->thunks, NULL)) goto L0003;
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_term, &chunk->thunks, &(chunk->values.buf[1]))) goto L0003;
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_RP, &chunk->thunks, NULL)) goto L0003;
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_atom_1, 2, 0);
            thunk->data.leaf.values.buf[1] = &(chunk->values.buf[1]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_ID(lc_context_t *ctx) {
    ...
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0000;
    {
        ...
        cq = ctx->pos;
        chunk->capts.buf[0].range.start = cp;
        chunk->capts.buf[0].range.end = cq;
    }
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0000;
    {
        pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_ID_0, 0, 1);
...
int lc_parse(lc_context_t *ctx, struct lambda **ret) {
    ...
    if (pcc_apply_rule(ctx, pcc_evaluate_rule_term, &thunks, ret))
